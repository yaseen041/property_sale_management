																...
																<tbody>
																	<tr style="border-bottom: 1px solid silver;">
																		<td class="header-row-td"align="center">
																			<img src="<?php echo base_url(); ?>assets/img/logo.png" style='width: 200px;background:transparent;border-radius: 4px;'>
																	...
																	<tr>
																		...
																		<legend> <u> Unlock Account! </u> </legend>
																	</td>
																</tr>
															</tbody>
														</table>
														<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
															<legend><b style="color: #777777;"> Dear User ! </b> </legend>
															<br> Your account has been locked due to multiple failed login attempts.
															<br> <br> click the link below to unlock your account. <br>

															<p align="center"> <a href="<?php echo base_url(); ?>account/unlock?email=<?php echo $email; ?>&secret=<?php echo $unique_id; ?>" class='button' role="button"> UNLOCK ACCOUNT </a> </p>

															<hr style="margin-top: 10px; margin-bottom: 10px;">
															<br>
															<p> If you have any further questions please contact us at <a href="mailto:contact@kiwitokiwi.co.nz">contact@kiwitokiwi.co.nz</a> </p>
															<br>
															<p> <b> Kind Regards,<br>
															KiwiToKiwi Support </b> </p>
												...
												<tr>
													<td class="table-col-td" width="448" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
														<table width="100%" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
															<tbody>
																<tr>
																	<td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;"
																	valign="top">
																	<a href="#" style="color: #428bca; text-decoration: none; background-color: transparent;">Copyright &copy; <?php echo date("Y"); ?> KTK HOLDINGS LIMITED. </a>
																	<br>
																</td>
															</tr>
														</tbody>
