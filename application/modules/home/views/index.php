            ...
            <div class="tpb tpb-property_simple_search col-md-12">
                <div class="container">
                    <div class="content-wrapper">
                        ...
                        <p class="description">Search property for sale or to rent in your area  |  Advertise your property for free</p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <img class="img-responsive" src="https://via.placeholder.com/800x500?text=Advertisement">
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <img class="img-responsive" src="https://via.placeholder.com/800x500?text=Advertisement">
                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <div class="property-item">
                                        <div class="property-heading">
                                            <span class="item-price"><?php echo currency().number_format($listing['price'],0); ?><?php echo ($listing['purpose'] == 'rent' || $listing['purpose'] == 'student') ? " PCM" : ""; ?></span>
