    ...
    <section class="become-space section-bg">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="editor"><?php echo @$list['description']; ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <hr>
        ...
        <script type="text/javascript">
            ...
            $('body').on('click', '#submit_list_details', function (event) {
                ...
                var property_desc = CKEDITOR.instances['editor'].getData();
                
                $.ajax({
                    url: '<?php echo base_url(); ?>listing/submit_data',
                    type: 'post',
                    data: value+"&property_desc="+property_desc,
                    dataType: 'json',
