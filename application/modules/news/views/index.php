										...
										<div class="col-lg-6 col-md-6 col-sm-6">
											...
											<div class="property-item">
												...
												<?php if (!empty($topic['articles'])) { ?>
													<h4>
														<a href="<?php echo base_url() .'news/'.$topic['articles'][0]['slug']; ?>">
															<?php echo $topic['articles'][0]['title']; ?>
														</a>
													</h4>
													<div class="img-box" style="background: url('<?php echo base_url() .'uploads/banners/'. $topic['articles'][0]['banner']; ?>');background-size: cover;height: 240px;background-position: center;">
														<a href="<?php echo base_url() .'news/'. $topic['articles'][0]['slug']; ?>" class="img-box__image">
													...
													<div class="property-content" style="padding-bottom: 0px !important">
														<p>
															<?php echo custom_substr(strip_tags($topic['articles'][0]['description']), 220); ?>
														</p>
													</div>
												<?php }else{ ?>
																...
																<div class="panel-body no-padding">
																	<ul class="post-listb">
																		<?php foreach ($topic['articles'] as $key => $article) {
																			...
																			<hr>
																			<li>
																				<div class="post-image"><a href="#"><img src="<?php echo base_url() .'uploads/banners/'. $article['banner']; ?>" alt="<?php echo $article['title']; ?>"></a></div>
																				<div class="post-content">
																					<span class="post-date"><?php echo date('M d, Y', strtotime($article['date_added'])); ?></span>
																					<a href="<?php echo base_url() .'news/'. $article['slug']; ?>"><?php echo $article['title']; ?></a>
																				</div>
																			</li>
																		<?php } ?>
																	</ul>
