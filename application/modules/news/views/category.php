...
<body class="header-1 page-header-1">
	...
	<section class="page-header">
		<div class="container">
			<h1 class="page-header-title"><?php echo $cat_name; ?></h1>
			<ul class="breadcrumb">
									...
									<div class="col-md-12">
										<div class="property-item">
											<div class="property-content post">
												<h4 style="padding-bottom: 30px !important;">No Article Found!</h4>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											...
											<div class="property-item">
												<div class="property-heading">
													<a style="font-size: 20px; padding: 8px;" href="javascript:void(0)" class="item-detail btn"><?php echo $cat_name; ?></a>
												</div>
												<div class="img-box">
