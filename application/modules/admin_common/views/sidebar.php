...
<div class="page-sidebar-wrapper">	
	<div class="page-sidebar navbar-collapse collapse">		
		<ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
			...
			<li class="nav-item <?=($this->uri->segment(2)=='articles' || $this->uri->segment(2)=='topics')?'active open':''?>">
				<a href="javascript:void(0)" class="nav-link nav-toggle">
				...
				<ul class="sub-menu">
					<li class="nav-item <?=($this->uri->segment(2)=='topics')?'active open':''?>">
						<a href="<?php echo base_url() ?>admin/topics" class="nav-link ">
							<span class="title">Categories</span>	
						</a>
					</li>
					<li class="nav-item <?=($this->uri->segment(2)=='articles')?'active open':''?>">
						<a href="<?php echo base_url() ?>admin/articles/" class="nav-link ">
