...
<script type="text/javascript">
    $(document).ready(function () {
        $(".mobi-nav").click(function(){
            $("#sidebar-wrapper").addClass("open-mobi-menu");
        });
        $(".closebtn").click(function(){
            $("#sidebar-wrapper").removeClass("open-mobi-menu");
        });
...
<script type="text/javascript">
    ...
    var europeCountries = ["AL","AD","AM","AT","BY","BE","BA","BG","CH","CY","CZ","DE","DK","EE","ES","FO","FI","FR","GB","GE","GI","GR","HU","HR","IE","IS","IT","LT","LU","LV","MC","MK","MT","NO","NL","PO","PT","RO","RU","SE","SI","SK","SM","TR","UA","VA","UK"];    
    function initialize() {
   ...
   function initialize2() {
    ...
    var cntry = 'UK';
    var options = {
     // componentRestrictions: {country: europeCountries}
 };
 var autocomplete2 = new google.maps.places.Autocomplete(input2, options);
 google.maps.event.addListener(autocomplete2, "place_changed", function () {
            //infowindow.close();
