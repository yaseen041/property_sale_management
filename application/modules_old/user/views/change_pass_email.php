														...
														<td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
															<table class="header-row" width="478" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
																<tbody>
																	...
																	<tr>
																		<td class="header-row-td" width="478" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #ed193f; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
																			<legend> 
																			Password Changed!</legend> <br><br>
																		</td>
																	</tr>
																</tbody>
															</table>
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
																<legend><b style="color: #777777;">Dear <?php echo get_session('username'); ?>,</b> </legend>
																<br> You've successfully changed your password.
																<br>
																<br>
																<hr>
																<br>
																<p> If you have any further questions please contact us at <a href="mailto:info@emc2property.co.uk">info@emc2property.co.uk</a> </p>
																<br>
																<p> <b> Kind Regards,<br>
																EMC2 Property </b> </p>
													...
													<tr>
														<td class="table-col-td" width="548" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
															<table width="100%" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
																<tbody>
																	<tr>
																		<td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background: #ED193F !important;" valign="top">
                                                                            <a href="#" style="color: #fff; text-decoration: none; background-color: transparent;">Copyright &copy; <?php echo date("Y"); ?> EMC2 Property.</a>
                                                                            <br>
                                                                        </td>
																	</tr>
																</tbody>
