                                ...
                                <div class="portlet box red ">
                                    ...
                                    <div class="portlet-body" id="content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <ul class="feature-list-address">
                                                    <li><?php echo currency().number_format($list['price']); ?></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <iframe src="http://maps.google.com/maps?q=<?php echo @$list['latitude']; ?>, <?php echo @$list['longitude']; ?>&z=15&output=embed" width="580" height="350" frameborder="0" style="border:0"></iframe>
                                            </div>
                                        </div>
