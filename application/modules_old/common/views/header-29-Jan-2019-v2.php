            ...
            <ul class="nav sidebar-nav col-xs-12">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
					<li><a href="">Help with using our website</a></li>
					<li><a href="">Free Services We Offer</a></li>
					<li><a href="">Free Property Advertising </a></li>
					<li><a href="">How to rent out your house</a></li>
                  </ul>
                </li>
                <li>
                   <a href="<?php echo base_url(); ?>contact_us">Contact Us</a>
                ...
                <?php if (get_session('user_logged_in')) { ?>
					...
					<?php } ?>
					 <?php if (!get_session('user_logged_in')) { ?>
						<button  class="btn sign-btn pull-right btn-primary mobi-btn-x" data-toggle="modal" data-target="#signModal"><i class="fa fa-user"></i>&nbsp;Sign Up</button>
						<button class="btn pull-right signin-btn btn-primary mobi-btn-x" data-toggle="modal" data-target="#loginModal"><i class="fa fa-sign-in"></i>&nbsp;Sign In</button>
