...
<footer id="footer" class="position-md-absolute">
        ...
        <div class="row footer-body">
            ...
            <div class="col-md-4 col-sm-6 footer-column footer-icon">
                ...
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12">
                        <p class="item-text"> support@emc2.com</p> 
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 social-icon">
                        <ul class="social-network social-circle">
                            <li style="margin-left: 0px;"><a href="#" class="icoFacebook" title="Facebook"><i class="fa fa-facebook"></i></a></li>
    ...
    <div class="copyright">
        <div class="container clearfix">
            <p> &copy; Copyright 2018 - All Rights Reserved By explorelogics.com</p>
        </div>
    </div>
