<?php
$all_topics = getAll('topics', 'is_active', 'Y');
?>
...
<div id="mySidenav" class="sidenav">
	...
	<?php }else{ ?>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
			<ul class="nav sidebar-nav col-xs-12">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<?php foreach ($all_topics as $key => $topic) { ?>
							<li><a href="<?php echo base_url().'news/category/'.$topic['slug']; ?>"><?php echo $topic['topic'] ?></a></li>
						<?php } ?>
					</ul>
				</li>
				<li>
				...
				<li class="dropdown">
					<?php $image = singleRow('users', '*','id = '.get_session('user_id'));
						...
						<a href="javascript:void(0)" style="background: none;" class="dropdown-toggle" data-toggle="dropdown">
							<img class="usr" src="<?php echo $src; ?>" alt="user">
						</a>
					<!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown">News <span class="caret"></span></a> -->
					<ul class="dropdown-menu">
				...
				<?php } ?>
				<?php if (!get_session('user_logged_in')) { ?>
					<button  class="btn sign-btn pull-right btn-primary mobi-btn-x btnClose" data-toggle="modal" data-target="#signModal"><i class="fa fa-user"></i>&nbsp;Sign Up</button>
					<button class="btn pull-right signin-btn btn-primary mobi-btn-x btnClose" data-toggle="modal" data-target="#loginModal"><i class="fa fa-sign-in"></i>&nbsp;Sign In</button>

				<?php }else{ ?>
					<a href="<?php echo base_url(); ?>logout" class="btn pull-right signin-btn btn-primary mobi-btn-x"><i class="fa fa-sign-out"></i>&nbsp;Logout</a>
					<a href="<?php echo base_url(); ?>listing/step1" class="btn pull-right signin-btn btn-primary mobi-btn-x"><i class="fa fa-plus"></i>&nbsp;Add New Listing</a>
				<?php } ?>
			</ul>
			<div class="col-xs-12">
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<button type="button" onclick="openNav()" class="open-nav navbar-toggle mobi-nav collapsed" aria-controls="navbar">
