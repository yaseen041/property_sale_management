	...
	<section class="page-header">
		<div class="container">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Boby Marley</li>
			</ul>
		</div>
	</section>
														...
														<div class="row">
															...
															<div class="col-lg-7 col-sm-7 property-padding">
																<div class="property-content listing-content">
																	...
																	<p>
																		<span class="property-price"><?php echo currency().number_format($list['price']); ?><?php echo ($list['purpose'] == 'rent' || $list['purpose'] == 'student') ? " PW" : ""; ?></span>
