...
//        }
        ...
        public function search_listing($page = '0'){
            ...
            if(!empty($data)){
                ...
                if(!empty($data['lat']) && !empty($data['long']) && !empty($data['within_miles']) && $data['within_miles'] != '25+'){
                ...
                foreach ($data['listings'] as $key => $value) {
                    ...
                    $data['map_listings'][$key]['title'] = $value['title'];
    ...
    // --------------   Code not used yet -----------------------------
        ...
        public function leaveMessage(){
            ...
            if ($this->form_validation->run() == false) {
                ...
                $data['admin'] = false;
                $data['body'] = "<br>
                A person have left a message against your property \"<b>".ucfirst($listing['title'])."\"</b>, Details are given below:
                <br><br>
                ...
                $finalResult = array('msg' => 'success', 'response' => "Your message has been sent to agency / individual.");
                echo json_encode($finalResult);
                exit;
            }
        }
