...
<body class="header-1 page-header-1">
    ...
    <section class="become-space section-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-10 col-xs-12 col-md-offset-3 col-sm-offset-1" style="margin-top: 40px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="editor"><?php echo @$listing_detail['description']; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <hr>
            ...
            <script type="text/javascript">
                ...
                CKEDITOR.replace(
                    ...
                    {
                        toolbar: [
                        ['Source','Cut','Copy','Paste','PasteText','Bold','Italic','Underline','Subscript','Superscript','NumberedList','BulletedList','Link','Unlink','Anchor','Styles','Format','Font','FontSize','TextColor','BGColor']
                        ],
                    },
                ...
                Dropzone.options.myDropzone = {
                    ...
                    init: function () {
                        ...
                        this.on("sendingmultiple", function (data, xhr, formData) {
                            ...
                            formData.append("property_desc" ,CKEDITOR.instances['editor'].getData());
