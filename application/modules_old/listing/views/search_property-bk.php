        ...
        <div class="search-result-content">
            ...
            <div class="container">
                ...
                <div class="container" style="padding-top: 24px;">
                    <div class="row">
                        <div class="col-md-10 col-sm-12 col-md-offset-1"><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- Search page ads -->
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-5699644453556247"
     data-ad-slot="1893011616"
     data-ad-format="auto"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7 col-sm-7 property-padding">
                                                                <div class="property-content listing-content">
                                                                    ...
                                                                    <p>
                                                                        <span class="property-price"><?php echo currency() . number_format($list['price']); ?><?php echo ($_GET['purpose'] == 'rent' || $_GET['purpose'] == 'student') ? " PW" : ""; ?></span>
...
function setMarkers(map) {
    for (var i = 0; i < locations.length; i++) {
        var loc = locations[i];
        var pw = ((loc['purpose'] == 'rent' || loc['purpose'] == 'student')?'PW':'');
        // console.log(pw);
